...
- What holding Escape does once the day's 60-minute custom-skip budget is spent (docs/SPEC.md §4B). Phase 3 decision — the gesture currently guarantees an escape, the skip system requires it stop.
