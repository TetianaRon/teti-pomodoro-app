...
- App name/branding.
- Whether Phase 4 should offer a **manual day-off override**. The ≥6 h rule cannot tell a genuine all-day offsite from a holiday — free/busy data simply doesn't carry the distinction — so an offsite would cut the cap to 3h. Bounded (Emergency Mode still works) but worth a deliberate decision.
